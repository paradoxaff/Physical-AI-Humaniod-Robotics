...
(module.exports = {
  ...
  tagline: 'Advanced Robotics and Embodied Intelligence Textbook',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/paradoxaff/Physical-AI-Humaniod-Robotics/edit/main/',
        },
        blog: {
    ...
    ({
      navbar: {
        ...
        logo: {
          ...
          src: 'img/robot-logo.svg', // We'll create this logo later
        },
        items: [
          {
            type: 'doc',
